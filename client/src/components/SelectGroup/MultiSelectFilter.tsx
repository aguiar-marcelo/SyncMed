...
const DropdownIndicator: React.FC<DropdownIndicatorProps<Option, true>> = (
  props
) => {
  return (
...
export default function MultiSelectFilter({
  ...
  return (
    <Select
      ...
      options={options}
      onChange={(newValues) =>
        onValueChange(newValues.map((v) => Number(v.value)))
      }
      value={options.filter((o) => selectedValues?.includes(Number(o.value)))}
      isDisabled={disabled}
      unstyled
