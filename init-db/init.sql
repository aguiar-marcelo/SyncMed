-- Garante que o banco de dados 'syncmed' existe
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'syncmed')
BEGIN
...
-- Se as tabelas existirem, as deleta (útil para desenvolvimento)
DROP TABLE IF EXISTS dbo.[schedulling];
DROP TABLE IF EXISTS dbo.[professional];
